class App.RestaurantDetailsView extends Backbone.View
  ...
  render: ->
    data = @model.asJSON()
    data.streetMapSource = "http://maps.googleapis.com/maps/api/streetview?size=300x200&location=#{@model.get('address')}&heading=0&sensor=false&key=AIzaSyBMOegAOwS3jDGWwMwuCbTaGcbmIkDsYF4"
